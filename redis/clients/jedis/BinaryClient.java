...
public class BinaryClient extends Connection
{
    ...
    static /* synthetic */ int[] $SWITCH_TABLE$redis$clients$jedis$BitOP() {
        final int[] $switch_TABLE$redis$clients$jedis$BitOP = BinaryClient.$SWITCH_TABLE$redis$clients$jedis$BitOP;
        if ($switch_TABLE$redis$clients$jedis$BitOP != null) {
            return $switch_TABLE$redis$clients$jedis$BitOP;
        }
        final int[] $switch_TABLE$redis$clients$jedis$BitOP2 = new int[BitOP.values().length];
        try {
            $switch_TABLE$redis$clients$jedis$BitOP2[BitOP.AND.ordinal()] = 1;
        }
        catch (NoSuchFieldError noSuchFieldError) {}
        try {
            $switch_TABLE$redis$clients$jedis$BitOP2[BitOP.NOT.ordinal()] = 4;
        }
        catch (NoSuchFieldError noSuchFieldError2) {}
        try {
            $switch_TABLE$redis$clients$jedis$BitOP2[BitOP.OR.ordinal()] = 2;
        }
        catch (NoSuchFieldError noSuchFieldError3) {}
        try {
            $switch_TABLE$redis$clients$jedis$BitOP2[BitOP.XOR.ordinal()] = 3;
        }
        catch (NoSuchFieldError noSuchFieldError4) {}
        return BinaryClient.$SWITCH_TABLE$redis$clients$jedis$BitOP = $switch_TABLE$redis$clients$jedis$BitOP2;
    }
    ...
    public enum LIST_POSITION
    {
        ...
        private LIST_POSITION(final String s, final int n) {
