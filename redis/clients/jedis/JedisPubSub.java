...
public abstract class JedisPubSub
{
    ...
    public abstract void onMessage(final String p0, final String p1);
    
    public abstract void onPMessage(final String p0, final String p1, final String p2);
    
    public abstract void onSubscribe(final String p0, final int p1);
    
    public abstract void onUnsubscribe(final String p0, final int p1);
    
    public abstract void onPUnsubscribe(final String p0, final int p1);
    
    public abstract void onPSubscribe(final String p0, final int p1);
