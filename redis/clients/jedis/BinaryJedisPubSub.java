...
public abstract class BinaryJedisPubSub
{
    ...
    public abstract void onMessage(final byte[] p0, final byte[] p1);
    
    public abstract void onPMessage(final byte[] p0, final byte[] p1, final byte[] p2);
    
    public abstract void onSubscribe(final byte[] p0, final int p1);
    
    public abstract void onUnsubscribe(final byte[] p0, final int p1);
    
    public abstract void onPUnsubscribe(final byte[] p0, final int p1);
    
    public abstract void onPSubscribe(final byte[] p0, final int p1);
